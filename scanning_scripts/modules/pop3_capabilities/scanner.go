...
type ScanResults struct {
	...
	// PreTLS is the targets response to CAPA in plain (pre-tls) state
	PreTLS string `json:"preTLS,omitempty"`

	// PostTLS is the targets response to CAPA in encrypted (post-tls) state
